...
<div id="vue-body">
    ...
    <!-- 表单部分开始 -->
    <form id="saveForm" action="@{staticResPath}/${entityName?uncap_first}/edit.ajax" data-find-url="@{staticResPath}/${entityName?uncap_first}/find.html">
        <div class="row">
            <div class="col-lg-12">
                <div class="main-box">
...
<script src="@{staticResPath}/resources/js/screen/${entityName?uncap_first}/edit.js?v=20170822"></script>
</body>