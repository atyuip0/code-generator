...
<div id="vue-body">
    ...
    <!-- 表单部分开始 -->
    <form id="saveForm" action="${d}{staticResPath}/${entityName?uncap_first}/add.ajax" data-find-url="${d}{staticResPath}/${entityName?uncap_first}/find.html">
        <div class="row">
            <div class="col-lg-12">
                <div class="main-box">
...
<script src="${d}{staticResPath}/resources/js/screen/${entityName?uncap_first}/add.js?v=20170822"></script>
</body>